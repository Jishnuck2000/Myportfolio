      ...
      <div className="home">
        <div className="bg1">
          <div className="bg11">
            ...
            <button className="btn-home3" data-aos="fade-up">Download CV</button>
            <a href="https://www.linkedin.com/in/jishnu-ck/"><button className="btn-home" data-aos="fade-up">
              ...
              <div className="content">
                ...
                <div className="img-p1">
                  <div className="img-p2">
                    <img src="/shield.png" className="shield"></img><h2 className="shield-h2">CYBER CARE</h2>
                  </div>
                  <div className="img-p3">
                 <ul> 
                  <li>The project involves creating a web application to educate people on cyber awareness and protect them from online threats, enhancing their digital safety and security.
</li>
<li>Technologies Used : React-js ,Express,MongoDB,Node-js    </li>
</ul>

                  </div>
                  <div className="img-p4">
                  <a href="https://github.com/Jishnuck2000">    
<button className="btn1-imgp4"><img src="/git1.png" className="git-imgp4" ></img>
<h3 className="git-btn">Github</h3>
</button></a>
<a href="https://effulgent-cannoli-2ff5bf.netlify.app/">
<button className="btn2-imgp4"><img src="/logout1.png" className="git-imgp4"></img>
            ...
            <div className="card">
              ...
              <div className="content">
                ...
                <div className="img-p11">
                  <div className="img-p2">
                    <img src="/logo.png" className="lincoln1"></img><h2 className="shield-h2"></h2>
                  </div>
                  <div className="img-p33">
                 <ul> 
                  <li>The luxury car clone web app employs CRUD operations, enabling users to Create, Read, Update, and Delete car listings. It mimics luxury car platforms, facilitating seamless browsing, editing, and management of vehicle data.
</li>
<li>Technologies Used : React-js ,Express,MongoDB,Node-js    </li>
</ul>
...
<button className="btn11-imgp4"><img src="/git1.png" className="git-imgp4"></img>
<h3 className="git-btn">Github</h3>
</button></a>
<a href="https://lincoln-mern.vercel.app/">
<button className="btn22-imgp4"><img src="/logout1.png" className="git-imgp4"></img>
<h3 className="git-btn">Go to web</h3>
</button></a>
...
<button className="btn111-imgp4"><img src="/git1.png" className="git-imgp4"></img>
<h3 className="git-btn">Github</h3>
</button>
<button className="btn222-imgp4"><img src="/logout1.png" className="git-imgp4"></img>
<h3 className="git-btn">Go to web</h3>
</button>
...
<form>
  ...
  <input type="text" className="bg52-i1"></input>
